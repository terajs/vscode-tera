...
function parseSessionSnapshot(value: unknown): SessionSnapshot | null {
  ...
  return {
    ...
    ai: {
      ...
      summary: readString(value.ai.summary),
      likelyCauses: readStringArray(value.ai.likelyCauses),
      nextChecks: readStringArray(value.ai.nextChecks),
      suggestedFixes: readStringArray(value.ai.suggestedFixes),
